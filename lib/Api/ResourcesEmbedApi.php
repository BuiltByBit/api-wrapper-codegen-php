...
/**
 * ResourcesEmbedApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class ResourcesEmbedApi
{
    ...
    /**
     * Operation getV2ResourcesEmbedLatest
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getV2ResourcesEmbedLatest'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetV2ResourcesEmbedLatest200Response
     */
    public function getV2ResourcesEmbedLatest($nonce = null, string $contentType = self::contentTypes['getV2ResourcesEmbedLatest'][0])
    {
        list($response) = $this->getV2ResourcesEmbedLatestWithHttpInfo($nonce, $contentType);
        return $response;
    }

    /**
     * Operation getV2ResourcesEmbedLatestWithHttpInfo
     *
     * Fetches the latest versions &amp; license information
     *
     * @param  string $nonce 32 character hash provided by an anti-piracy placeholder of the NONCE type. Must be from a resource download (cannot be an addon download’s nonce, etc). (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetV2ResourcesEmbedLatest200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getV2ResourcesEmbedLatestWithHttpInfo($nonce = null, string $contentType = self::contentTypes['getV2ResourcesEmbedLatest'][0])
    {
        $request = $this->getV2ResourcesEmbedLatestRequest($nonce, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetV2ResourcesEmbedLatest200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetV2ResourcesEmbedLatest200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetV2ResourcesEmbedLatest200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\GetV2ResourcesEmbedLatest200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation getV2ResourcesEmbedLatestAsync
     *
     * Fetches the latest versions &amp; license information
     *
     * @param  string $nonce 32 character hash provided by an anti-piracy placeholder of the NONCE type. Must be from a resource download (cannot be an addon download’s nonce, etc). (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV2ResourcesEmbedLatestAsync($nonce = null, string $contentType = self::contentTypes['getV2ResourcesEmbedLatest'][0])
    {
        return $this->getV2ResourcesEmbedLatestAsyncWithHttpInfo($nonce, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getV2ResourcesEmbedLatestAsyncWithHttpInfo
     *
     * Fetches the latest versions &amp; license information
     *
     * @param  string $nonce 32 character hash provided by an anti-piracy placeholder of the NONCE type. Must be from a resource download (cannot be an addon download’s nonce, etc). (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV2ResourcesEmbedLatestAsyncWithHttpInfo($nonce = null, string $contentType = self::contentTypes['getV2ResourcesEmbedLatest'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetV2ResourcesEmbedLatest200Response';
        $request = $this->getV2ResourcesEmbedLatestRequest($nonce, $contentType);
    ...
    /**
     * Create request for operation 'getV2ResourcesEmbedLatest'
     *
     * @param  string $nonce 32 character hash provided by an anti-piracy placeholder of the NONCE type. Must be from a resource download (cannot be an addon download’s nonce, etc). (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getV2ResourcesEmbedLatest'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getV2ResourcesEmbedLatestRequest($nonce = null, string $contentType = self::contentTypes['getV2ResourcesEmbedLatest'][0])
    {



        $resourcePath = '/v2/resources/embed/latest';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
