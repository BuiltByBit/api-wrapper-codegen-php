 ...
 */
class Analytic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Analytic';
    ...
    protected static $openAPITypes = [
        ...
        'graph' => 'bool',
        'single' => 'bool',
        'filters' => 'array<string,\OpenAPI\Client\Model\AnalyticFiltersValue>',
        'periods' => 'string[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('single', $data ?? [], null);
    ...
    */
     ...
     * Sets graph
     *
     * @param bool|null $graph Whether or not this analytic can be requested via the /v2/analytics/graph endpoint.
     *
     * @return self
     */
     ...
     * Sets single
     *
     * @param bool|null $single Whether or not this analytic can be requested via the /v2/analytics/single endpoint.
     *
     * @return self
     */
    ...
    {
        if (is_null($single)) {
            throw new \InvalidArgumentException('non-nullable single cannot be null');
        }
     ...
     * Gets filters
     *
     * @return array<string,\OpenAPI\Client\Model\AnalyticFiltersValue>|null
     */
     ...
     * Sets filters
     *
     * @param array<string,\OpenAPI\Client\Model\AnalyticFiltersValue>|null $filters filters
     *
     * @return self
     */
