...
class Review implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('written_by_id', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getWrittenById()
    {
        return $this->container['written_by_id'];
    }

    /**
     * Sets written_by_id
     *
     * @param string|null $written_by_id written_by_id
     *
     * @return self
     */
    public function setWrittenById($written_by_id)
    {
        if (is_null($written_by_id)) {
            throw new \InvalidArgumentException('non-nullable written_by_id cannot be null');
        }
        $this->container['written_by_id'] = $written_by_id;
