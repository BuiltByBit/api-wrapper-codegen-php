# OpenAPI\Client\ResourcesCreatorBatchApi

All URIs are relative to https://api.builtbybit.com, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**getV2ResourcesCreatorBatch()**](ResourcesCreatorBatchApi.md#getV2ResourcesCreatorBatch) | **GET** /v2/resources/creator/batch | Fetch a list of your batches edits |
| [**postV2ResourcesCreatorBatch()**](ResourcesCreatorBatchApi.md#postV2ResourcesCreatorBatch) | **POST** /v2/resources/creator/batch | Submit a new batch edit |
...
$apiInstance = new OpenAPI\Client\Api\ResourcesCreatorBatchApi(
...
try {
    ...
    echo 'Exception when calling ResourcesCreatorBatchApi->getV2ResourcesCreatorBatch: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ResourcesCreatorBatchApi->postV2ResourcesCreatorBatch: ', $e->getMessage(), PHP_EOL;
}
```
