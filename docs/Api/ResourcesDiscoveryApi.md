# OpenAPI\Client\ResourcesDiscoveryApi

All URIs are relative to https://api.builtbybit.com, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**getResourcesDiscoverCategories()**](ResourcesDiscoveryApi.md#getResourcesDiscoverCategories) | **GET** /v2/resources/discover/categories | Fetch a list of categories |
| [**getResourcesDiscoverResources()**](ResourcesDiscoveryApi.md#getResourcesDiscoverResources) | **GET** /v2/resources/discover/resources | Fetch a list of resources |
| [**getV2ResourcesDiscoverCartView()**](ResourcesDiscoveryApi.md#getV2ResourcesDiscoverCartView) | **GET** /v2/resources/discover/cart/view | View the user&#39;s cart items |
| [**getV2ResourcesDiscoverLicenses()**](ResourcesDiscoveryApi.md#getV2ResourcesDiscoverLicenses) | **GET** /v2/resources/discover/licenses | Fetch a list of the user&#39;s licenses |
| [**postV2ResourcesDiscoverCartAdd()**](ResourcesDiscoveryApi.md#postV2ResourcesDiscoverCartAdd) | **POST** /v2/resources/discover/cart/add | Add items to a user&#39;s cart |
| [**postV2ResourcesDiscoverCartCheckout()**](ResourcesDiscoveryApi.md#postV2ResourcesDiscoverCartCheckout) | **POST** /v2/resources/discover/cart/checkout | Initiate a checkout of a user&#39;s cart |
| [**postV2ResourcesDiscoverCartCouponAdd()**](ResourcesDiscoveryApi.md#postV2ResourcesDiscoverCartCouponAdd) | **POST** /v2/resources/discover/cart/coupon/add | Add a coupon to the user&#39;s cart |
| [**postV2ResourcesDiscoverCartCouponRemove()**](ResourcesDiscoveryApi.md#postV2ResourcesDiscoverCartCouponRemove) | **POST** /v2/resources/discover/cart/coupon/remove | Remove a coupon from the user&#39;s cart |
| [**postV2ResourcesDiscoverCartRemove()**](ResourcesDiscoveryApi.md#postV2ResourcesDiscoverCartRemove) | **POST** /v2/resources/discover/cart/remove | Remove an item from the user&#39;s cart |
...
$apiInstance = new OpenAPI\Client\Api\ResourcesDiscoveryApi(
...
try {
    ...
    echo 'Exception when calling ResourcesDiscoveryApi->getResourcesDiscoverCategories: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ResourcesDiscoveryApi->getV2ResourcesDiscoverCartView: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ResourcesDiscoveryApi->getV2ResourcesDiscoverLicenses: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ResourcesDiscoveryApi->postV2ResourcesDiscoverCartAdd: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ResourcesDiscoveryApi->postV2ResourcesDiscoverCartCheckout: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ResourcesDiscoveryApi->postV2ResourcesDiscoverCartCouponAdd: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ResourcesDiscoveryApi->postV2ResourcesDiscoverCartCouponRemove: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ResourcesDiscoveryApi->postV2ResourcesDiscoverCartRemove: ', $e->getMessage(), PHP_EOL;
}
```
